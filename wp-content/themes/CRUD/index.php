...
<html lang="en">
   ...
   <body>
      <?php if(!is_page("layout-home")){ ?>
      <div class="jumbotron">
         <div class="container">
            <h1>CRUD</h1>
            <p>Get de lista dos conteúdos cadastrados no wp-admin.</p>
         </div>
      </div>
      <div class="container crud">
         <div>
            ...
            <ul id="tabList" class="nav nav-tabs" role="tablist">
               <li role="presentation" class="active"><a href="#produtoTab" aria-controls="produtoTab" role="tab" data-toggle="tab">Produtos</a></li>
               <li role="presentation"><a href="#clienteTab" aria-controls="clienteTab" role="tab" data-toggle="tab">Clientes</a></li>
               <li role="presentation"><a href="#pedidoTab" aria-controls="pedidoTab" role="tab" data-toggle="tab">Pedidos</a></li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content">
               <div role="tabpanel" class="tab-pane active" id="produtoTab">
                  <h3>Produtos</h3>
                  <?php 
               ...
               <div role="tabpanel" class="tab-pane" id="clienteTab">
                  <h3>Clientes</h3>
                  <?php 
                     $posts = get_posts(array(
                         'posts_per_page'	=> -1,
               ...
               <div role="tabpanel" class="tab-pane" id="pedidoTab">
                  <h3>Pedidos</h3>
                  <div id="primary">
                           ...
                           <div class="entry-content">
                              ...
                              <?php if( $pedidos ): ?>
                                 ...
                                 <?php 
                                    ...
                                    <div class="col-md-12 id-ped"><br /><b>ID:</b> <?php echo $pedido->ID; ?></div><br />
      ...
      <header>
         <figure>
            <a href="#">
            <img src="/wp-content/themes/CRUD/static/img/banner.png" alt="Banner Topo" class="img-responsive center-block" />
            </a>
         </figure>
      </header>
       
      <!--full banner topo -->
      <article class="col-md-12 menubar">
            <figure class="col-md-2 logo-top">
               <a href="#">
               <img src="/wp-content/themes/CRUD/static/img/logo.png" alt="Logo Header" class="img-responsive" />
               </a>
            </figure>
            <!-- logomarca -->
            <div class="col-md-8">
      ...
      <article class="col-md-12 reset-col">
         ...
         <!--menu header-->
         <div class="bottom-list-up">
            <div>
               <article class="col-md-12 reset-col">
                  <section class="top-destaques">
                     <ul class="list-inline">
                        <li>
                           <a href="#">
                              <figure>
                        ...
                        <li>
                           ...
                           <?php
                              ...
                              if( !empty($image) ): ?>
                           <img src="<?php echo $image['url']; ?>" class="img-destaque-menor" alt="<?php echo $image['alt']; ?>" />
                           <?php endif; ?>
                           </a>
                        </li>
                        <li>
                  ...
                  <section class="bottom-destaques">
